...
class Main_window(QMainWindow):
    """
    Класс отвечает за работу окна и графики
    """
    ...
    def save_new_element(self):
        ...
        if dif:
            for line in dif:
                # Анализ
                answer = base_search(base=gl_base, cursor=gl_cursor, number=line['number'])
                print(answer)
    ...
    # Функция указания новой ссылки на чертёж
    ...
    def add_element(self):
        ...
        for num in range(column_count):
            self.sp_table.setItem(row_count, num,
                                  QtWidgets.QTableWidgetItem(str('')))  # Мнимое заполнение, для удобства
    ...
    Подумать над поиском и удалением неиспользуемых компонентов.
    ...
    Поробовать при обновлении закрывать соединие с базой и открывать его заново. Эффекта нет
    Сделать открытие и закрытие файла с моделью дерева принудительно в ручную controller line 131 
    №№№№№№№№№№№№№№№№№№№№№№№№№ ПРОБЛЕМА №№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№
    
    ::::::::::::::::::::::: РАЗРАБОТКА:::::::::::::::::::::::::::::::::
    сделать добавление сборки
    Загрузка дерева при запуске (с вопрашающей галкой)
    удаление компонентов с окошком подтверждения
    Сделано удаление детали. Работа над удалением сборки. 05.04.2023
    Удаление сборки работает, работа над сохранением изменений при редактировании.
    ::::::::::::::::::::::: РАЗРАБОТКА:::::::::::::::::::::::::::::::::
